  (function () {
    ...
    var MCP_PEEK_STEPS = [
      ['① 云端起服务（一次性，约 5 分钟）',
       '点下面的链接，用 GitHub 登录授权。它会建两个服务：server（手机连它）+ mcp（我连它）。部署完在 mcp 服务里复制 LINJIAN_TOKEN。',
