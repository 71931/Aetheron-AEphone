  (function () {
    ...
    function memberEditBody(m) {
      ...
      form += '<div class="field">' + memFieldLabel(7, 'NPC 列表');
    ...
    function openMemberEdit(idx) {
      ...
      memDirty = false;
      memNpcEditIdx = null; memNpcDraft = null; memRoleFormCache = null;
    ...
    function chatAutoSendImgIfAsked(conv) {
      try {
        ...
        if (roleCfg && typeof chatRoleGenImageApi === 'function') {
          ...
          _pos.push('聊天里给对方发一张刚拍的照片：' + _scenes[Math.floor(Math.random() * _scenes.length)]);
          ...
          if (_prompt) {
            ...
            chatRoleGenImageApi(roleCfg, _prompt, _neg, _face, function (src) {
              chatShrinkImgSrc(src, function (out) {
                ...
                addChatMsg('other', { type: 'image', imgs: [out], picNote: '刚拍的近照' }, conv);
              });
            }, function (err) {
              chatRoleGenBusy = false;
      ...
      chatMini('让 TA 现画一张',
        ...
        '开始画', function () {
          ...
          chatRoleGenImageApi(cfg, prompt, neg, ref, function (src) {
            chatShrinkImgSrc(src, function (out) {
              chatRoleGenBusy = false;
              var note = (desc || '').slice(0, 60) || 'AI 生图';
              addChatMsg('other', { type: 'image', imgs: [out], img: out, picNote: note });
              toast('TA 画好发过来了');
            });
          }, function (msg) {
            chatRoleGenBusy = false;
    ...
    function renderChatSettings() {
      ...
      var sections = [
        ...
        { key: 'sec-sense', label: '交互感知', desc: '语音配置 · 我的形象 · 角色相册 · 自主活动' },
