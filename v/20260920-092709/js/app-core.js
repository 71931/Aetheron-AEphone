  (function () {
    ...
    function mcpRenderXhs() {
      ...
      html += '<div class="mcp-sec"><div class="mcp-sec-t">通道地址（手机读小红书靠它）</div><div class="group-card mcp-gw">' +
        ...
        '<input class="mcp-input" id="mcpGwToken" type="text" placeholder="令牌（脚本 --token 填的那个，可留空）" value="' + mcpAttr(_gwv.token) + '">' +
        ...
        '<div class="mcp-gw-steps">①点下面下载桥接脚本，放跑 MCP 的那台机器上　②复制启动命令，在那台机器上跑起来　③回来填地址、点测连通</div>' +
        '<a class="mcp-dl" href="../../tools/xhs_bridge.py" download>下载桥接脚本 xhs_bridge.py</a>' +
    ...
    var XHS_BRIDGE_CMD = 'python3 xhs_bridge.py --mcp http://localhost:18061/mcp --port 18901 --token aetheron';
